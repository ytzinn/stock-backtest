...
> | `F_pbr_no_r3r4` | 15.8196% | 인컴번트 (구 16.28%) |
...
>
> **`F_pbr_ma200`이 인컴번트를 앞서지만 채택하지 않는다** — 일별 NAV net CAGR은 14.4498%로
> 인컴번트(14.0799%) 대비 +0.37%p지만, **MDD(net)가 −54.61% → −62.61%로 8.00%p 악화**해

...
> **2026-07-30에 61개 태그 전부 동결 스냅샷에서 재발행**했다. 현행 공식 수치는 **SPEC_13 §9-9**.
> 요점: 채택 후보 `F_pbr_no_r3r4` gross **15.8196%** / 일별 NAV 공식 net **14.0799%**,
> `D_rim_only` **9.5408%**, `F_momentum_rim` **15.4233%**, `G_full` **7.8026%**,
> `H_no_stability` **14.7171%**, `E_screener_rim` **6.8388%**.
> **채택 상태는 여전히 "보류"다** — SPEC_10 G5(일별 net MDD −54.61%)가 −45% 한계를 위반한다.

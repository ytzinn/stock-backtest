...
ABLATION_CONFIGS: dict[str, dict] = {
    ...
    'F_pbr_mktresid126':   {'use_hard': True,  'use_stability': True,  'use_screener': False,
                            ...
                            'momentum_criterion': {'type': 'market_residual_blitz_subset',
                                                   ...
                                                   'skip_days': 21}},
    # 사용자 요청(2026-07-23) — MA 이중조건 기간 탐색 그리드. **사전등록 primary 아님,
    # §6-2 그리드서치 방지 규칙에 따라 결과를 즉시 PASS로 쓰지 않는다.** 후보 발굴 후
    # 다시 가설로 사전등록해 별도 검증 필요. confirm_days=5/slope_lookback=20 고정,
    # ma_short/ma_long만 변화 — 기존 20/60(F_pbr_no_r3r4)의 이웃 조합.
    'F_pbr_ma5_20':        {'use_hard': True,  'use_stability': True,  'use_screener': False,
                            'use_rim_filter': False,
                            'stability_rules': {'R1', 'R2', 'R5', 'R6'},
                            'rank_mode': 'pbr',
                            'momentum_criterion': {'type': 'ma_double_adapter', 'tag': 'F_pbr_ma5_20',
                                                   'ma_short': 5, 'ma_long': 20}},
    'F_pbr_ma5_60':        {'use_hard': True,  'use_stability': True,  'use_screener': False,
                            'use_rim_filter': False,
                            'stability_rules': {'R1', 'R2', 'R5', 'R6'},
                            'rank_mode': 'pbr',
                            'momentum_criterion': {'type': 'ma_double_adapter', 'tag': 'F_pbr_ma5_60',
                                                   'ma_short': 5, 'ma_long': 60}},
    'F_pbr_ma5_120':       {'use_hard': True,  'use_stability': True,  'use_screener': False,
                            'use_rim_filter': False,
                            'stability_rules': {'R1', 'R2', 'R5', 'R6'},
                            'rank_mode': 'pbr',
                            'momentum_criterion': {'type': 'ma_double_adapter', 'tag': 'F_pbr_ma5_120',
                                                   'ma_short': 5, 'ma_long': 120}},
    'F_pbr_ma20_120':      {'use_hard': True,  'use_stability': True,  'use_screener': False,
                            'use_rim_filter': False,
                            'stability_rules': {'R1', 'R2', 'R5', 'R6'},
                            'rank_mode': 'pbr',
                            'momentum_criterion': {'type': 'ma_double_adapter', 'tag': 'F_pbr_ma20_120',
                                                   'ma_short': 20, 'ma_long': 120}},
    'F_pbr_ma60_120':      {'use_hard': True,  'use_stability': True,  'use_screener': False,
                            'use_rim_filter': False,
                            'stability_rules': {'R1', 'R2', 'R5', 'R6'},
                            'rank_mode': 'pbr',
